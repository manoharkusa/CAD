...
set mem_usage [lindex [get_metric flow.memory] 1]
echo "Memory usage: ${mem_usage}M" > ./reports/session_memory_usage_runtime.rpt
set peak_mem_usage [lindex [get_metric flow.memory.resident.peak] 1]
echo "Peak Memory usage: ${peak_mem_usage}M" >> ./reports/session_memory_usage_runtime.rpt
