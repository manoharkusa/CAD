...
#check_design -type library -format detail > ${cur_stage_dir}/reports/check_design.library.rpt
check_timing_library_consistency > ${cur_stage_dir}/reports/check_design.library.rpt
#check_design -type netlist -format detail > ${cur_stage_dir}/reports/check_design.netlist.rpt
check_netlist -out_file ${cur_stage_dir}/reports/check_design.netlist.rpt
#check_design -type synthesis -format detail > ${cur_stage_dir}/reports/check_design.synthesis.rpt
