...
class MetricsCollector:
    ...
    def __init__(self, args):
        ...
        # Output files
        self.json_file = self.run_dir / f"{self.project}_{self.block_name}_{self.runtag}_metrics.json"
        self.csv_file = self.run_dir / f"{self.project}_{self.block_name}_{self.runtag}_metrics.csv"
...
Examples:
  ...
  ./collect_metrics.py --stage route --stage-dir ./run1/pnr/route \\
    ...
    parser.add_argument('--rtl-tag',
                        default=os.environ.get('RTL_TAG', 'no_tag'),
