...
# --- Progress Update ---
# Report intra-stage progress with a descriptive message.
# Example: ui_progress "Loading libraries"
# Example: ui_progress "Synthesis mapping in progress"
# Example: ui_progress "Generating reports"
proc ui_progress {message} {
    puts "UI_MSG PROGRESS $message"
    flush stdout
}
