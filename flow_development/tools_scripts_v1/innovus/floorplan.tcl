...
source ${tool_scripts}/common_procs_innovus.tcl
...
report_power_domains > $report_dir/power_domain.rpt
...
check_endcaps > $report_dir/check_endcaps.rpt
...
write_report $report_dir/macro_halo_report.rpt [get_macro_halo_report]
...
report_timing_summary > $report_dir/report_timing_summary.rpt
...
check_connectivity -nets $pg_nets -ignore_dangling_wires -out_file $report_dir/check_pg_connectivity.rpt
