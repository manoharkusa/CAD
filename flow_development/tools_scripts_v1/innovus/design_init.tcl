...
check_netlist -out_file ${cur_stage_dir}/reports/check_netlist_verbose.rpt
...
write_report ${cur_stage_dir}/reports/lef_files.rpt  [get_db init_lef_files]
write_report ${cur_stage_dir}/reports/process_node.rpt [get_db design_process_node]
check_netlist > ${cur_stage_dir}/reports/check_netlist.rpt
