...
if {[file exists $env(BLOCK_SCRIPTS)/post_postroute_holdopt.tcl]} {
    source $env(BLOCK_SCRIPTS)/post_postroute_holdopt.tcl
}
...
write_report ../reports/net_wire_lengths.rpt $context
