...
if {[dict exists $block_cfg synthesis_corners]} {
	set synthesis_view [dict get $block_cfg synthesis_corners]
	ui_warn "Block setting override: Synthesis view is [dict get $PROJ_PDK synthesis_corners] changed to $synthesis_view"
	echo "synthesis_corners: $synthesis_view" > ../reports/block_overrides.rpt
