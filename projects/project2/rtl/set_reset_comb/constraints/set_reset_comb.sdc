...
analyze -format sverilog ../set_reset_comb.sv

elaborate set_reset_comb
compile
link	

create_clock -period 10 -name clk [get_ports {clk}]
set_input_delay [expr 10 * 0.4] -clock clk [get_ports [remove_from_collection [all_inputs] clk]]
set_output_delay [expr 10 * 0.4] -clock clk [get_ports [all_outputs]]
...
report_timing
write_sdc rom_set_reset_comb_sdc.sdc
write_file -hierarchy -format verilog -output set_reset_comb_netlist.v
#pwd
