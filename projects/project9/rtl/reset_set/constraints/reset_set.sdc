...
analyze -format sverilog ../reset_set.sv
...
set_input_delay [expr 5 * 0.6] -clock clk [get_ports [remove_from_collection [all_inputs] clk]]
set_output_delay [expr 5 * 0.6] -clock clk [get_ports [all_outputs]]
